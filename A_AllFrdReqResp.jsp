...
<head>
<title>Admin All Friend Request And Responses Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	   <h2 class="style5">All Request and Response Details...</h2>
	...
	while ( rs.next() )
	{
		...
		s4=rs.getString(5);
			...
			count++;
					...
					%>
							<tr bgcolor="#FFFFFF">
								<td  width="142" height="0" valign="baseline" bgcolor="#00FFFF" "><div align="center"><span class="style6 style4">&nbsp;&nbsp;
						        <%out.println(s1);%>
							  </span></div></td>	
								<td  width="141" height="0" valign="baseline" bgcolor="#00FFFF"><div align="center"><span class="style6 style4">&nbsp;&nbsp;
						        <%out.println(s2);%>
							  </span></div></td>
								<td  width="115" height="0" valign="baseline" bgcolor="#00FFFF"><div align="center"><span class="style6 style4">&nbsp;&nbsp;
						        <%out.println(s3);%>
							  </span></div></td>
							  <td  width="188" height="0" valign="baseline" bgcolor="#00FFFF"><div align="center"><span class="style6 style4">&nbsp;&nbsp;
					          <%out.println(s4);%>
							  </span></div></td>
			  </tr>
					<%
				...
				if(count==0){out.print("There is no friend Request And Responses");}
