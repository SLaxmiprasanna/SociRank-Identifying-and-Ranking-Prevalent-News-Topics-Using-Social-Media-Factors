    ...
    <div class="content_resize">
      <div class="mainbar">
        ...
        <tr bgcolor="#99CCCC">
          ...
          <td  width="51" height="34" valign="baseline" bgcolor="#00FFFF" style="color: #2c83b0;"><div align="center" class="style4" > Tweeter Name </div></td>
		  <td  width="76" height="34" valign="baseline" bgcolor="#00FFFF" style="color: #2c83b0;"><div align="center" class="style4" > Tweet Image </div></td>
		  <td  width="108" height="34" valign="baseline" bgcolor="#00FFFF" style="color: #2c83b0;"><div align="center" class="style4" >Tweet Name</div></td>
          <td  width="90" height="34" valign="baseline" bgcolor="#00FFFF" style="color: #2c83b0;"><div align="center" class="style4" >Tweeted Date</div></td>
          <td  width="91" height="34" valign="baseline" bgcolor="#00FFFF" style="color: #2c83b0;"><div align="center" class="style4" >SociRank </div></td>
		  <td  width="226" height="34" valign="baseline" bgcolor="#00FFFF" style="color: #2c83b0;"><div align="center" class="style4" >Tweet Rate</div></td>
            ...
            <tr>
			  ...
			  <td height="0"  valign="middle" bgcolor="#99FF33">
                  <div align="center" class="style4" >
                    <div align="center">
                   <a href="A_UserProfile.jsp?uname=<%=s2%>&type=<%="user1"%>"> <%out.println(s2);%> </a>
                </div>
              </div></td>
