	   ...
	   <p><img src="images/ALogin.jpg" width="160" height="138" /></p>
		<form name="s" action="Authentication.jsp?value=<%="adminlogin"%>" method="post" onSubmit="return valid()"  ons target="_top">
              <table width="452" align="left" bgcolor="#FFFF00">
                  <tr>
                    <td width="225" height="35" class="style5"><span class="style2 style9">Admin Name (required)</span></td>
                    <td width="215" class="style5"><input name="adminid" class="text " id="name"  /></td>
                  </tr>
                  <tr>
                    <td height="38" class="style5"><span class="style2 style9">Password (required)</span></td>
