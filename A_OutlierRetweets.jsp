...
<head>
<title>Admin All Outlier Re-Tweets Details</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <h2 align="center" class="style5">All User Outlier Re-Tweets On The Tweet </h2>
	
		<p><table width="547" border="1.5" align="center"  cellpadding="0" cellspacing="0" >
				<tr bgcolor="#99FF00">
			      <td colspan="5" ><h2 class="style6">Outlier Re-Tweets </h2></td>
	      </tr>
			...
			<div align="left" class="style7 style14 style5 style6" style="margin-left:20px;"><strong> Re-Tweeted Date </strong></div></td>
					...
					while ( rs12.next() )
			             ...
			             String t12=rs12.getString(2).toLowerCase();
							  ...
							  if ((retweet.contains(t12)) || (retweet.contains(t2)) )
									{count1++;}else{
		...
		<tr>
			...
			<%}else{%>
			 ...
			 <td  width="182" height="44" valign="middle" bgcolor="#CCFF00" style="color:#000000;">
			   <div align="left" class="style10 style7 style9 style2" style="margin-left:20px;"><strong><em><a href="A_UserProfile.jsp?uname=<%=c_user%>&type=<%="user6"%>&id=<%=one%>"> <%out.println(c_user);%> 
		    </a></em></strong></div></td>
			<%}%>
...
<%					
						...
						if(count==0){
										out.print("No one User Have outliered Re-Tweeted On This Tweet");
								}
		...
		<P align="right"><a href="A_OutlierTweets.jsp">Back</a></P>
