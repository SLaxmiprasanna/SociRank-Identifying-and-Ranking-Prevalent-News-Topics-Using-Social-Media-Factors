...
<head>
<title>Admin Outlier Tweets Details Page</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
	  ...
	  <h2 class="style5">All Users Outlier Re-Tweets Details</h2>
        ...
        <tr bgcolor="#99CCCC">
		  ...
		  <td  width="80" height="34" valign="baseline" bgcolor="#00FFFF" style="color: #2c83b0;"><div align="center" class="style4" >Outlier Re-Tweets </div></td>
        </tr>
            ...
            <tr>
			  ...
			  <td height="0"  valign="middle" bgcolor="#99FF33">
                  <div align="center" class="style4" >
                    <div align="center">
                  <a href="A_UserProfile.jsp?uname=<%=s2%>&type=<%="user5"%>">  <%out.println(s2);%> </a>
                </div>
              </div></td>
			   ...
			   <td height="0"  valign="middle" bgcolor="#99FF33">
                  <div align="center" class="style4"  >
                    <div align="center" >
       			   <a href="A_TweetDetails.jsp?id=<%=j%>&type=<%="outlier"%>&tname=<%=s0%>"> <%out.println(s0);%> </a>               </div>
              </div></td>
	    ...
	    %>
			   ...
			   <td height="0"  valign="middle" bgcolor="#99FF33">
                  ...
                  <a href="A_OutlierRetweets.jsp?id=<%=j%>&type=<%="allTweets"%>&tname=<%=s0%>"> Re-Tweets </a>			  </strong></div></td>
            </tr>
            <%
					i=i+1;	
