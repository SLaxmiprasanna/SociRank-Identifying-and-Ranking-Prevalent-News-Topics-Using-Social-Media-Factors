...
<%@ page import="org.bouncycastle.util.encoders.Base64"%>
		...
		<tr>
			...
			<%}else{%>
			 ...
			 <td  width="182" height="44" valign="middle" bgcolor="#CCFF00" style="color:#000000;">
			   <div align="left" class="style10 style7 style9 style2" style="margin-left:20px;"><strong><em><a href="A_UserProfile.jsp?uname=<%=c_user%>&type=<%=type%>&id=<%=one%>"> <%out.println(c_user);%> 
		    </a></em></strong></div></td>
			<%}%>
...
<%					
			 ...
			 <h2 align="right">&nbsp;</h2>
			<% 
			if(type.equalsIgnoreCase("clusters")){%>
