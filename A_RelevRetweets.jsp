...
<head>
<title>Admin All Relevent Re-Tweets Details</title>
    ...
    <div class="content_resize">
	  ...
	  <h2 align="center" class="style5">All User Relevant Re-Tweets On The Tweet </h2>
		...
		<p><table width="547" border="1.5" align="center"  cellpadding="0" cellspacing="0" >
				<tr bgcolor="#99FF33">
				    <td colspan="10" ><h2 class="style6">Positive Re-Tweets </h2></td>
	      </tr>
			...
			<div align="left" class="style7 style14 style5 style6" style="margin-left:20px;"><strong> Re-Tweeted Date </strong></div></td>
					...
					<%
					   ...
					   int one= Integer.parseInt(request.getParameter("id"));	
						String s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,s13,pos="possitive",neg="Negative";
						...
						{   
					   		...
					   		while ( rs1.next() )
					   		{
							    ...
							    String retweet=rs1.getString("re_tweet").toLowerCase();
								
							count1=0;	
							
							
					String sql2="select * from filter where categorie='"+pos+"' ";
					Statement st2=connection.createStatement();
			  		ResultSet rs2=st2.executeQuery(sql2);
					while ( rs2.next() )
			   			{
			   			 String	t1=rs2.getString(1).toLowerCase();
			             String t2=rs2.getString(2).toLowerCase();
			   			 	
							  if ((retweet.contains(t2)))
									{
									
					String sql12="select * from filter where categorie='"+neg+"' ";
					Statement st12=connection.createStatement();
			  		ResultSet rs12=st12.executeQuery(sql12);
					while ( rs12.next() )
			   			{
			   			 String	t11=rs12.getString(1).toLowerCase();
			             String t12=rs12.getString(2).toLowerCase();
			   			 	
							  if ((retweet.contains(t12)))
									{count1++;}else{
		...
		<tr>
			...
			<%}else{%>
			 ...
			 <td  width="182" height="44" valign="middle" bgcolor="#CCFF00" style="color:#000000;">
			   <div align="left" class="style10 style7 style9 style2" style="margin-left:20px;"><strong><em><a href="A_UserProfile.jsp?uname=<%=c_user%>&type=<%="user4"%>&id=<%=one%>"> <%out.println(c_user);%> 
		    </a></em></strong></div></td>
			<%}%>
...
<%					   }
						...
						if(count==0){
										out.print("No one User Have Possitive Re-Tweeted On This Tweet");
								}
			...
			<p><table width="547" border="1.5" align="center"  cellpadding="0" cellspacing="0" >
				<tr bgcolor="#99FF33">
				    <td colspan="5" ><h2 class="style6">Negative Re-Tweets </h2></td>
		      </tr>
			<tr bgcolor="#00FF99"><td width="127" height="44" valign="middle" style="color: #2c83b0;">
			<div align="left" class="style5 style14 style7 style6" style="	margin-left:20px;"><strong><strong>Image</strong></strong></div></td>
			<td width="80" height="44" valign="middle" style="color: #2c83b0;">
			...
			<div align="left" class="style7 style14 style5 style6" style="margin-left:20px;"><strong> Re-Tweeted Date </strong></div></td>
					...
					String sql12="select * from filter where categorie='"+pos+"' ";
					Statement st12=connection.createStatement();
			  		ResultSet rs12=st12.executeQuery(sql12);
					while ( rs12.next() )
			   			{
...
<%						}
						...
						if(count==0){
										out.print("No one User Have Negative Re-Tweeted On This Tweet");
								}
			...
			<p><table width="547" border="1.5" align="center"  cellpadding="0" cellspacing="0" >
				<tr bgcolor="#99FF00">
				    <td colspan="5" ><h2 class="style6">Neutral Re-Tweets </h2></td>
		      </tr>
			<tr bgcolor="#00FF99"><td width="127" height="44" valign="middle" style="color: #2c83b0;">
			<div align="left" class="style5 style14 style7 style6" style="	margin-left:20px;"><strong><strong>Image</strong></strong></div></td>
			<td width="80" height="44" valign="middle" style="color: #2c83b0;">
...
<%						}
						...
						if(count==0){
										out.print("No one User Have Neutral Re-Tweeted On This Tweet");
								}
            ...
            <h3 align="right"><a href="A_Relevent.jsp" class="style4">Back</a></h3>
