...
<head>
<title>Admin Tweet Details Page</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	    ...
	    <h2 class="style5">Tweet <%= request.getParameter("tname")%> Details...</h2>
                <p class="style6">&nbsp;</p>
                <p>
...
%>
 ...
 <table border="1" align="center" cellpadding="0" cellspacing="0"  width="600" >
				 				<tr >
								    <td width="148" rowspan="9" bgcolor="#00FFFF" ><div class="style22 style4 style5" style="margin:10px 13px 10px 13px;" > 
		                        ...
		                        <input  name="image" type="image" src="images.jsp?value=<%="tweet"%>&id=<%=i%>" style="width:120px; height:120px;"  />
								  	...
								  	<td width="128" height="27" bgcolor="#00FFFF" >
								  <div align="center" class="style10 style7 style6"><strong>Uploader Name </strong></div></td>
							      <td width="316" bgcolor="#00FFFF"><div align="center" class="style8 style7"><strong><a href="A_UserProfile.jsp?uname=<%=s1%>&type=<%=type%>&id=<%=i%>&name=<%=s0%>"><%= s1%></a></strong></div></td>
		  						<tr/>
									<td width="128" height="27" bgcolor="#00FFFF" >
								  <div align="center" class="style10 style7 style6"><strong>Tweet Name </strong></div></td>
								    <td bgcolor="#00FFFF"><div align="center" class="style8 style7"><strong><%= s0%></strong></div></td>
				    
				    
				    			<tr>
									<td width="128" height="27" bgcolor="#00FFFF">
						  		  <div align="center" class="style10 style7 style6"><strong>Tweet Description </strong></div></td>
							      <td bgcolor="#00FFFF"><div align="center" class="style8 style7"><strong><textarea style="background:#66FFFF" rows="3" cols="43" ><%= s3%> </textarea> </strong></div></td>
								</tr>
								<tr>
									<td width="128" height="27" bgcolor="#00FFFF">
								  <div align="center" class="style10 style7 style6"><strong>Tweet Uses </strong></div></td>
							      <td bgcolor="#00FFFF"><div align="center" class="style8 style7"><strong><%= s2%></strong></div></td>
				    			</tr>
								<tr>
										<td width="128" height="27" bgcolor="#00FFFF">
								  <div align="center" class="style10 style7 style6"><strong>Uploaded Date </strong></div></td>
						          <td bgcolor="#00FFFF"><div align="center" class="style8 style7"><strong><%= s4%></strong></div></td>
								</tr>
								<tr>
								<tr>
										<td width="128" height="27" bgcolor="#00FFFF">
								  <div align="center" class="style10 style7 style6"><strong>Tweet Rank </strong></div></td>
						          <td bgcolor="#00FFFF"><div align="center" class="style8 style7"><strong><%= rank%></strong></div></td>
								</tr>
								<tr>
										<td width="128" height="27" bgcolor="#00FFFF">
								  <div align="center" class="style10 style7 style6"><strong>Tweet Rate </strong></div></td>
								        <td bgcolor="#00FFFF"><div align="center" class="style8 style7"><strong>  
							            <% 
