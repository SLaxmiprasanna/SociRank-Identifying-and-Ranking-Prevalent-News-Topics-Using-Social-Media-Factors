  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	  	 ...
	  	 <h2 align="center" class="style5" >Add Tweet Filters...</h2>
	         <div class="clr"></div>
...
<form name="s" method="post" y action="A_TweetFiltersIns.jsp" onSubmit="return valid()"  ons target="_top">            
...
<td height="30" colspan="2" id="learn_more" align="center"  style="color:#FFFFFF;"><input type="submit" value="Add" style="width:100px; height:25px; background-color:#000000; color:#FFFFFF;"/></td>
  ...
  <div class="style6"> <a href="A_ViewFilters.jsp"> View Filters </a> </div>  
