  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	   ...
	   <h2 align="center" class="style5">All Tweets With Total Re-tweetes In Perticular Day In Chart...</h2>
	   <%String tname=request.getParameter("tname");%>
	  <iframe src="Results2.jsp?tname=<%=tname%>" height="400" width="600" style="background:#FFFFFF"></iframe>
		  <div align="center" class="style51">( Number of Times Users Re-tweeted on Tweet Every Day)	      </div>
	  
	  <p align="right"><a href="A_TweetsCharts.jsp">Back</a></p>
