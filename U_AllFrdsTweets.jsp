  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	   ...
	   <h2 class="style8">All Friends Tweets And Retweets Details...</h2>
		...
		String str1="select * from req_res where ((requestfrom='"+s2+"'&&requestto='"+uname+"') || (requestfrom='"+uname+"'&&requestto='"+s2+"'))&& status='Accepted'"; 
            ...
            <tr>
			  ...
			  <td height="0"  valign="middle" bgcolor="#99FF33">
                  <div align="center" class="style4" >
                    <div align="center">
                    <a href="U_UserProfile.jsp?uname=<%=s2%>&type=<%="user2"%>"> <%out.println(s2);%> </a>
                </div>
              </div></td>
			   ...
			   <td height="0"  valign="middle" bgcolor="#99FF33">
                  <div align="center" class="style4"  >
                    <div align="center" >
       			  <a href="U_TweetDetails.jsp?id=<%=j%>&rank=<%=rank%>&type=<%="allfrdstweets"%>&tname=<%=s0%>">  <%out.println(s0);%>  </a>              </div>
              </div></td>
	    ...
	    %>
			   ...
			   <td height="0"  valign="middle" bgcolor="#99FF33">
                  ...
                  <a href="U_Re-TweetNews.jsp?id=<%=j%>&tname=<%=s0%>&type=<%="frdsTweetsouter"%>">Re-Tweet</a>		  </strong></div></td>
            </tr>
            <%
					i=i+1;	
