  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	   ...
	   <h2 class="style8">All My Tweets And Retweet Details...</h2>
        ...
        <tr bgcolor="#99CCCC">
		  ...
		  <td  width="233" height="34" valign="baseline" bgcolor="#00FFFF" style="color: #2c83b0;"><div align="center" class="style4" >Re-Tweets Details</div></td>
        </tr>
            ...
            <tr>
              <td height="0"  valign="middle" bgcolor="#99FF33">
			   ...
			   <td height="0"  valign="middle" bgcolor="#99FF33">
                  <div align="center" class="style4"  >
                    <div align="center" >
       			  <a href="U_MyTweetDetails.jsp?id=<%=j%>&type=<%="allmytweets"%>&tname=<%=s0%>"> <%out.println(s0);%> </a>               </div>
              </div></td>
	    ...
	    %>
			   ...
			   <td height="0"  valign="middle" bgcolor="#99FF33">
                  ...
                  <a href="U_Re_Tweets.jsp?id=<%=j%>&type=<%="AllTweetsDetails"%>">Re-Tweets Details</a>		  </strong></div></td>
            </tr>
            <%
					i=i+1;	
