...
<head>
<title>User All User Tweets Details Page</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	  	...
	  	<h2 class="style5">All Users Tweets Details</h2>
        ...
        <tr bgcolor="#99CCCC">
          ...
          <td  width="76" height="34" valign="baseline" bgcolor="#00FFFF" style="color: #2c83b0;"><div align="center" class="style4" > Tweeter Name </div></td>
		  ...
		  <td  width="233" height="34" valign="baseline" bgcolor="#00FFFF" style="color: #2c83b0;"><div align="center" class="style4" >Re-Tweet </div></td>
            ...
            <%
					  ...
					  int i=1,j=0,count=0,rank=0,k=0;
						...
						try 
						{
						   	...
						   	String query="select * from tweets where uname!='"+user+"' "; 
						...
						String str1="select * from req_res where ((requestfrom='"+s2+"'&&requestto='"+user+"') || (requestfrom='"+user+"'&&requestto='"+s2+"'))&& status='Accepted'"; 
            ...
            <tr>
			  ...
			  <td height="0"  valign="middle" bgcolor="#99FF33">
                  <div align="center" class="style4" >
                    <div align="center">
                   <a href="U_UserProfile.jsp?uname=<%=s2%>&type=<%="user3"%>"> <%out.println(s2);%> </a>
                </div>
              </div></td>
			   ...
			   <td height="0"  valign="middle" bgcolor="#99FF33">
                  <div align="center" class="style4"  >
                    <div align="center" >
       			   <a href="U_TweetDetails.jsp?id=<%=j%>&type=<%="allUserTweets"%>&tname=<%=s0%>&rank=<%=rank%>"> <%out.println(s0);%> </a>               </div>
              </div></td>
	    ...
	    %>
			   ...
			   <td height="0"  valign="middle" bgcolor="#99FF33">
                  ...
                  <a href="U_Re-TweetNews.jsp?id=<%=j%>&type=<%="allUserTweets"%>&tname=<%=s0%>">Re-Tweet</a>			  </strong></div></td>
            </tr>
            <%
					i=i+1;	
		   ...
		   <p>&nbsp;</p>
                  <div align="right"><a href="U_SearchTweet.jsp">Back</a></div>
