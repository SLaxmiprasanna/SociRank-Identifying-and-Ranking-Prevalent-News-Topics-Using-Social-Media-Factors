...
%>
 ...
 <table border="1" align="center" cellpadding="0" cellspacing="0"  width="600" >
				 				<tr >
								    <td width="148" rowspan="8" bgcolor="#99FF00" ><div class="style22 style4 style5" style="margin:10px 13px 10px 13px;" > 
				    			...
				    			<tr>
									<td width="128" height="27" bgcolor="#99FF00">
						  		  <div align="center" class="style10 style7"><strong>Tweet Description </strong></div></td>
								    <td bgcolor="#99FF00"><div align="center" class="style8"><strong><%= descr%></strong></div></td>
								</tr>
								<tr>
									<td width="128" height="27" bgcolor="#99FF00">
								  <div align="center" class="style10 style7"><strong>Tweet Uses </strong></div></td>
								    <td bgcolor="#99FF00"><div align="center" class="style8"><strong><%= s2%></strong></div></td>
				    			</tr>
								<tr>
										<td width="128" height="27" bgcolor="#99FF00">
								  <div align="center" class="style10 style7"><strong>Uploaded Date </strong></div></td>
								        <td bgcolor="#99FF00"><div align="center" class="style8"><strong><%= s4%></strong></div></td>
								</tr>
								<tr>
								<tr>
										<td width="128" height="27" bgcolor="#99FF00">
								  <div align="center" class="style10 style7"><strong>Tweet Rank </strong></div></td>
								        <td bgcolor="#99FF00"><div align="center" class="style8"><strong><%= rank%></strong></div></td>
								</tr>
								<tr>
										<td width="128" height="27" bgcolor="#99FF00">
								  <div align="center" class="style10 style7"><strong>Tweet Rate </strong></div></td>
								        <td bgcolor="#99FF00"><div align="center" class="style8"><strong>  
							            <% 
