...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	    <h2 class="style10">User <%=(String)application.getAttribute("uname")%>'s Profile...</h2>
          <div class="clr"></div>
          <p>&nbsp;</p>
          <table width="533" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
            ...
            <%
					...
					%>
            <tr>
              <td width="226" rowspan="10" ><div class="style7 style26" style="margin:10px 13px 10px 13px;" ><strong><a class="#" id="img1" href="#" >
            ...
            <tr>
              <td height="43" align="left" valign="middle" style="color: #2c83b0;"><div align="left" class="style15 style42 style60 style61 style7 style8" style="margin-left:10px;"><strong>Location</strong></div></td>
            ...
            <tr>
              <td   width="141" height="44" align="left" valign="middle" style="color: #2c83b0;"><div align="left" class="style15 style42 style61 style60 style7 style8" style="margin-left:10px;"><strong>Status</strong></div                        ></td>
              <td  width="158" align="left" valign="middle" style="color: #2c83b0;"><div align="left">
                  <div align="left" class="style62 style4 style3 style9 style7" style="margin-left:10px;"><strong>
                    <%out.println(s6);%>
              </strong></div></td>
            </tr>
			
			<tr>
              <td   width="141" height="44" align="left" valign="middle" style="color: #2c83b0;"><div align="left" class="style15 style42 style61 style60 style7 style8" style="margin-left:10px;"><strong>View Map </strong></div                        ></td>
              <td  width="158" align="left" valign="middle" style="color: #2c83b0;"><div align="left">
                  <div align="left" style="margin-left:10px;" ><strong>
                   <h3><a href="U_GoogleMap.jsp?username1=<%=user%>&address1=<%=s3%> ">Map</a></h3>
              </strong></div></td>
            </tr>
