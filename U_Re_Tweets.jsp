...
<%@ page import="org.bouncycastle.util.encoders.Base64"%>
		...
		<tr>
			...
			<%if(c_user.equalsIgnoreCase(uname)){%>
			...
			<%}else if(c_user.equalsIgnoreCase("Admin")){%>
			   <td  width="182" height="44" valign="middle" bgcolor="#CCFF00" style="color:#000000;">
			   <div align="left" class="style10 style7 style9 style2" style="margin-left:20px;"><strong><em> <%out.println(c_user);%> 
 		    </em></strong></div></td>
...
<%					
			 ...
			 <h2 align="right">&nbsp;</h2>
			<% 
			if(type.equalsIgnoreCase("AllTweetsDetails")){%>
            <h2 align="right"><a href="U_AllTweetsDetails.jsp" class="style4">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("myposts")){%>
            <h2 align="right"><a href="U_AllMyImages.jsp" class="style4">Back</a></h2>
			<%}
