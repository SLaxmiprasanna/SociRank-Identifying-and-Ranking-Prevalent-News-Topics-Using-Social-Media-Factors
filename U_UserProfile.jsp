...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
	    <h2 class="style10">User <%=request.getParameter("uname")%>'s Profile...</h2>
          <div class="clr"></div>
          <p>&nbsp;</p>
		  ...
		  %>
            ...
            <h2 align="right"><a href="U_MyTweetDetails.jsp?id=<%=id%>&type=<%=type%>&tname=<%=name%>" class="style4">Back</a></h2>
			<%}
            ...
            <h2 align="right"><a href="U_TweetDetails.jsp?id=<%=id%>&type=<%=type%>&tname=<%=name%>&rank=<%=rank%>" class="style4">Back</a></h2>
			<%}
